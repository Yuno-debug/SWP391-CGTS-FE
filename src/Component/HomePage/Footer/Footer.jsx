    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section about">
          <h3>About CGTS</h3>
          <p className="text">The Child Growth Tracking System (CGTS) is dedicated to helping parents and healthcare 
        ...
        <div className="footer-section quick-links">
          ...
          <ul>
            ...
            <li className="text">Our Products</li>
        ...
        <div className="footer-section contact">
          <h4>Contact</h4>
          <p className="text">Email: cgts@gmail.com</p>
          <p className="text">Phone: +123 456 7890</p>
          <p className="text">Address: Lưu Hữu Phước Tân Lập, Đông Hoà, Dĩ An, Bình Dương, Việt Nam</p>
        </div>
      </div>
